...
export default function Menu(props) {
  ...
  return (
    <nav className="flex items-start md:items-center justify-between max-w-screen-xl mx-auto">
      ...
      <div
        className={`flex flex-col fixed md:font-normal top-0 md:top-auto right-0 md:right-auto md:relative md:flex-row justify-around items-center px-4 py-20 md:p-4 lg:space-x-6 text-xl md:text-l uppercase font-sans-300 bg-light-coral md:bg-transparent h-screen md:h-auto w-screen md:w-auto
      ...
      >
        ...
        <a href="https://www.rezac.dev/resume.pdf" className="p-4 whitespace-no-wrap">
          Resume <FontAwesomeIcon icon="download" className="" />
        </a>
        <div className="text-2xl md:text-xl flex justify-between pr-5">
          <Socials />
        </div>
      </div>
    </nav>
